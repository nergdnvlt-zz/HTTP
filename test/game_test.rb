...
class GameTest < MiniTest::Test
  ...
  def test_guess_correct
    ...
    assert_equal 'Correct! You are too good.', result
  end
  ...
  def test_results_too_high
    ...
    result = game.guess(99)
    assert_equal 'Nope, too high!', result
    assert_equal 'Nope, too high! With 1 attempt! Your last guess was 99.', game.results
    result2 = game.guess(90)
    assert_equal 'Nope, too high!', result2
    assert_equal 'Nope, too high! With 2 attempts! Your last guess was 90.', game.results
  end
  ...
  def test_results_low
    ...
    assert_equal 'Sorry, too low!', result
    assert_equal 'Sorry, too low! With 1 attempt! Your last guess was 12.', game.results
    result2 = game.guess(18)
    assert_equal 'Sorry, too low!', result2
    assert_equal 'Sorry, too low! With 2 attempts! Your last guess was 18.', game.results
  end
end
